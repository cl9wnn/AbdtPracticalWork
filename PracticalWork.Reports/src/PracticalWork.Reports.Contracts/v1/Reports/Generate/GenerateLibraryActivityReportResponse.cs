...
/// <summary>
/// Ответ на запрос о генерации отчета с данными об активности библиотеки
/// </summary>
...
public sealed record GenerateLibraryActivityReportResponse(string Name, string FilePath, ReportStatus Status, DateTime GeneratedAt)
